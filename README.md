...
| `pipeline/configs/cybervadis.json` | Config client pour le PPTX |
...
- **Manuel** : Actions → *Screaming Frog lite - cybervadis.com* → Run workflow
...
URL : **https://willotalexispro.github.io/sanity-check-cybervadis/**
...
Expéditeur : `noreply@mail.cybervadis.com` (domaine vérifié sur Resend)
...
- Envoyé au webhook n8n : `https://n8n.cybervadis.com/webhook/44f8feb9-f516-43ce-aacc-e12729743ca8`
...
4. Modifier `pipeline/configs/cybervadis.json` (nom client)
5. Mettre à jour les URLs dans `.github/workflows/crawl.yml` :
   - `--crawl https://cybervadis.com/`
